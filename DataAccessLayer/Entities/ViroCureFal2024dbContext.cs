...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.PersonId).HasName("PK__Person__543848DF9FD624CC");
        ...
        {
            entity.HasKey(e => new { e.PersonId, e.VirusId }).HasName("PK__person_v__7BFA2E3FDF1AB9FF");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__ViroCure__B9BE370F50F285D8");

            entity.ToTable("ViroCureUser");

            entity.HasIndex(e => e.Email, "UQ__ViroCure__AB6E616460F75E14").IsUnique();
        ...
        {
            entity.HasKey(e => e.VirusId).HasName("PK__Virus__FC266E03C2E2894F");
